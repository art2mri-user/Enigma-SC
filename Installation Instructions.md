...
./Enigma-SC.sh
```
If you are running **Enigma-SC** in a server, or if you couldn`t install all the packages listed on the **2) Download and Install Enigma-SC** section, you can run the pipeline without opening the GUI, via command line, open a terminal **inside of the Enigma-SC folder** and type:  
